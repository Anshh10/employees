...
function RelievingLetter() {
  ...
  const fetchUser = async () => {
    const response = await axios
      .get(`/api/relieving-letter/${user_id}`)
              ...
              <Row style={{ marginBottom: "1em", marginTop: "1em" }}>
                <Col>
                  <h3 style={{ textAlign: "left" }}>
                    {user.first_name} {user.last_name} Internship Completion
                    Letter
                  </h3>
                </Col>
                <Col>
                  ...
                  <div className="letterBody">
                    ...
                    <Row>
                      <p className="Tdouble-enter">
                        ...
                        was designated as "{user.jobRole}" with {user.company}{" "}
                        from {moment(user.stDate).format("Do MMMM YYYY")} till{" "}
                    ...
                    <Row>
                      <p className="Tdouble-enter">
                        ...
                        was very much interested to learn the functions of our
                        core division and willing to put{" "}
                        {(() => {
                          if (user.titles === "Mr.") {
                            return "his";
                          }
                        ...
                        efforts and get into the depth of the subject to
                        understand it better.
                      </p>
                      <p className="Tdouble-enter">
                        We thank you for your services to this company and wish
                        you the best of luck in all your future endeavors
                      </p>
                    </Row>
                    <Row style={{ padding: "40px 0" }}>
                      <p className="Tsingle-enter">
                        <span className="boldText"> Best Wishes,</span>
                      </p>
                      <p className="Tsingle-enter">
          ...
          return (
            <>
              <Row style={{ textAlign: "center" }}>
                <h3>Error Occured (No Relieving Letter Found) </h3>
                <h4>Contact the HR or the ADMIN</h4>
              </Row>
            </>
          );
        }
