        ...
        <Row style={{ marginBottom: "1em", marginTop: "1em" }}>
          <Col>
            <h3 style={{ textAlign: "left" }}>
              {user.first_name} {user.last_name}Internship Letter
            </h3>
          </Col>
          <Col>
          ...
          >
            <div className="letterBody">
              ...
              <Row style={{ margin: "30px 0px" }}>
                ...
                >
                  SUB: INTERNSHIP OFFER OF APPOINTMENT
                </h3>
              </Row>
              <Row>
                ...
                <p className="Tdouble-enter">
                  ...
                  <span className="boldText">{user.jobRole} Intern</span> for{" "}
                  {user.intDuration} at{" "}
              ...
              <Row style={{ padding: "20px 30px" }}>
                <ol className="Lsingle-enter">
                  ...
                  <li>
                    The working days will be started from Monday to Saturday.
                    The working hours would be Full-Time.
                  </li>
                  <li>
                    Your monthly stipend will be Rs. {user.salary}/- per month,
                    you will receive a variable number of incentives based on
                    your performance. After the completion of your target.
                  </li>
                  <li>
              ...
              <Row>
                <p className="Tsingle-enter">
                  ...
                  in building {user.company} into a world-class organization.
                </p>
              </Row>
